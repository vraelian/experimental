...
export const TUTORIAL_DATA = {
    'market_intro': {
        title: 'Market Basics',
        trigger: { type: 'VIEW_LOAD', viewId: 'market-view' },
        steps: [
            {
                ...
                highlightElementId: 'market-prices', // Highlight the whole market container
                position: { desktop: 'center', mobile: 'top' },
                size: { width: '350px' },
                completion: { type: 'ACTION', action: 'buy-item' }, // Generic buy action
            ...
            },
            {
                ...
                position: { desktop: 'center', mobile: 'top' },
                size: { width: '350px' },
                completion: { type: 'ACTION', action: 'sell-item' }, // Generic sell action
                nextStepId: null // End of this tutorial batch
            }
        ]
    },
    'shipyard_intro': {
        title: 'Shipyard & Hangar',
        trigger: { type: 'VIEW_LOAD', viewId: 'starport-view' },
        steps: [
            {
                stepId: 'shipyard_intro_1',
                text: 'This is the <span class="hl-cyan">Shipyard</span> where you can buy new vessels. The <span class="hl-cyan">Hangar</span> stores all ships you currently own.',
                highlightElementId: 'starport-shipyard-panel',
                position: { desktop: 'left', mobile: 'top' },
                size: null, // Use default size
