...
export class GameState {
    ...
    startNewGame(playerName) {
        const initialState = {
            day: 1, lastInterestChargeDay: 1, lastMarketUpdateDay: 1, currentLocationId: 'loc_mars', activeNav: 'ship', activeScreen: 'navigation', isGameOver: false, popupsDisabled: false,
            pendingTravel: null,
            player: {
                name: playerName, playerTitle: 'Captain', playerAge: 24, lastBirthdayYear: DATE_CONFIG.START_YEAR, birthdayProfitBonus: 0,
                credits: CONFIG.STARTING_CREDITS, debt: 0, weeklyInterestAmount: 0,
